...
async def start(c, m):
    ...
    await m.reply_text(
        text=f"Hi there {m.from_user.first_name}.\n\nI'm TG BOT LAB's Project Known As Screenshot Generator Bot. I can provide screenshots from your video files with out downloading the entire file (almost instantly). For more details check /help.",
        quote=True,
